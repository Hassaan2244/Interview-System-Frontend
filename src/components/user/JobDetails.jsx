import { Calendar, CheckCircle, AlertCircle, Briefcase, ChevronLeft, MapPin, DollarSign } from "lucide-react"
      ...
      <Card className="border border-gray-200 shadow-sm">
        ...
        <CardContent className="pt-4 space-y-6">
          <div className="space-y-3">
            ...
            <CardDescription className="text-gray-700 pl-1">
              {job.description}
            </CardDescription>
          </div>
          ...
          {job.requirements && (
            <div className="space-y-3">
              ...
              <CardDescription className="text-gray-700 whitespace-pre-line pl-1">
                {job.requirements}
              </CardDescription>
            </div>
          )}
